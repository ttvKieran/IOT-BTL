...
Code Arduino cho ESP32 đã được tạo trong thư mục `ESP32_SmartGarden/`:

- **ESP32_SmartGarden.ino** - Code chính cho ESP32
- **README.md** - Hướng dẫn chi tiết cài đặt và sử dụng
- **ARCHITECTURE.md** - Sơ đồ kiến trúc hệ thống
- **config_example.h** - File cấu hình mẫu

## 🚀 Quick Start

1. Mở Arduino IDE
2. Cài đặt các thư viện cần thiết (xem README.md)
3. Mở file `ESP32_SmartGarden/ESP32_SmartGarden.ino`
4. Cấu hình WiFi và MQTT trong code
5. Upload lên ESP32

## 📖 Chi tiết

Xem file `ESP32_SmartGarden/README.md` để biết:
- Danh sách thư viện cần cài đặt
- Sơ đồ kết nối phần cứng
- Cấu hình chi tiết
- Cấu trúc MQTT Topics và JSON Messages
- Troubleshooting

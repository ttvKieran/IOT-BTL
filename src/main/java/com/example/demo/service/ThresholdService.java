...
public class ThresholdService {
    ...
    public void checkAndAutomate(String deviceUid, DeviceStateDTO.SensorData sensorData) {
        ...
        int duration = setting.getMaxPumpDurationSeconds();
